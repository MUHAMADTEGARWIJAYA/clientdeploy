...
const articles = [
  {
    ...
    date: "2 Oktober 2024",
    readTime: "5 Menit",
    imageUrl: "1.png", // Ganti dengan URL gambar Anda
  },
  {
    title: "5 Strategi Pemasaran untuk Tingkatkan Penjualan Kambing di KambingFresh",
    category: "Manajemen Toko",
    date: "5 November 2024",
    readTime: "6 Menit",
    imageUrl: "4.jpg", // Ganti dengan URL gambar Anda
  },
  {
    ...
    readTime: "7 Menit",
    imageUrl: "5.jpg", // Ganti dengan URL gambar Anda
  },
  {
    ...
    readTime: "5 Menit",
    imageUrl: "2.jpg", // Ganti dengan URL gambar Anda
  },
];
...
const ArticlesSection = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-100 flex flex-col items-center relative">
      {/* Back Button */}
      <a href="/home">
        <button className="absolute top-4 left-4 text-blue-500 text-xl z-20">&larr; Kembali</button>
      </a>
      ...
      <div className="max-w-screen-xl  px-4 bg-white py-8 shadow-lg mt-8">
       <a href="/artikel"> <h2 className="text-2xl font-bold mb-6">Edukasi Penggunaan Platform</h2></a>
       ...
       {/* Articles Section 2 */}
       <div className="max-w-screen-xl  px-4 bg-white py-8 shadow-lg mt-8">
        <h2 className="text-2xl font-bold mb-6">Artikel untuk kembangkan bisnis anda</h2>
        <div className="grid grid-cols-1  sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {use.map((use, index) => (
            <div
              key={index}
